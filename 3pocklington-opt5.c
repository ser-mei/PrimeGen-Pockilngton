...
int main()
{
    ...
    file = fopen("3pocklington-opt5-sinArray.txt", "w");
    ...
    {
        fprintf(file, "3Pocklington-Optimizado5 Con Trial Division y sin Array de primos\n");
        fprintf(file, "nbits \t ktests \t avgtime \t totaltime \t errors \t sizefails\n");
    }
